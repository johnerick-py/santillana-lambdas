...
KEY_PREFIX_EVENT_LOG = 'streaming_pas/event/'
KEY_PREFIX_UNKNOWN = 'streaming_pas/entitykey_unknown/'
KEY_PREFIX_PROCESSED = 'streaming_pas/entity_key/'
KEY_PREFIX_ERROR = 'streaming_pas/event_error/redshift_conn/'
