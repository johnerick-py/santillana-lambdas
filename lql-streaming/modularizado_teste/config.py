...
# Prefixos S3
KEY_PREFIX_RAW = 'streaming_lql/validacao-wicco/'
KEY_PREFIX_EVENT_LOG = 'streaming_lql/event/'
KEY_PREFIX_UNKNOWN = 'streaming_lql/unknown/'
KEY_PREFIX_PROCESSED = 'streaming_lql/action/'
KEY_PREFIX_ERROR = 'streaming_lql/event_error/redshift_conn/'

# Configurações Kinesis
KINESIS_NAME = "pas-datastream-lql"
